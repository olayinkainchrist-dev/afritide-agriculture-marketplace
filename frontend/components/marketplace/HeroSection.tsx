...
export default function HeroSection() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (query.trim()) router.push(`/marketplace?q=${encodeURIComponent(query)}`);
  };
  ...
  return (
    <section className="relative min-h-[94vh] flex flex-col justify-center overflow-hidden bg-[#060f08]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/5 w-[360px] h-[360px] bg-emerald-600/7 rounded-full blur-[110px]" />
        {/* Top edge line */}
