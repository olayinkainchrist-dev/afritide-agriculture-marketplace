"""
Afritide - User Model
Covers all 9 user roles: Buyer, Farmer, Cooperative, Exporter,
Processing Company, Logistics Provider, Warehouse Operator,
...
class UserStatus(str, enum.Enum):
    ...
    ACTIVE = "active"             # Email verified, fully active
    UNDER_REVIEW = "under_review" # KYC submitted, under admin review
    VERIFIED = "verified"         # KYC approved, verified badge
...
class User(Base):
    ...
    export_countries = Column(Text, nullable=True)  # JSON array
    ...
    response_rate = Column(Float, default=0.0, nullable=False)   # % of messages responded
